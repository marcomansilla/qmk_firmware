...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT(
         ...
         KC_LCHO,   KC_A,    KC_R,    KC_S,    KC_T,    KC_G,  /**/     KC_K,    KC_N,    KC_E,    KC_I,    KC_O,        KC_ENT,
         KC_LSPO,     KC_X,    KC_C,    KC_D,    KC_V,    KC_Z, /**/     KC_M,    KC_H,    KC_COMM, KC_DOT,  KC_SLSH, KC_RSPC,
         KC_TAB, OSM(MOD_LALT), KC_LGUI, KC_NAV, KC_BSFN1,     /**/    KC_SPFN2,      OSM(MOD_RALT), KC_RGUI, KC_FN3,  KC_RCBS
        ),

  [_QWERTY] =
  LAYOUT(
         KC_ESC,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,   /**/  KC_Y,    KC_U,    KC_I,    KC_O,    KC_P,    KC_MINS, KC_QUOT,
         KC_LCHO,   KC_A,    KC_S,    KC_D,    KC_F,    KC_G,  /**/   KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN,     KC_ENT,
