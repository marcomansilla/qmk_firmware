...
LAYOUT(
       ...
       KC_TAB,  MOD_LGUI(KC_A),  MOD_LALT(KC_R),  MOD_LCTL(KC_S),  MOD_LSFT(KC_T),  LT(_FN1, KC_G), \
       LT(_FN2, KC_M),  MOD_RSFT(KC_N),  MOD_RCTL(KC_E),  MOD_RALT(KC_I),   NOD_RGUI(KC_O),  KC_ENT, \
